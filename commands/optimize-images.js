...
const MOBILE_LCP = path.join(PUBLIC_DIR, "online-insurance.webp");
const DESKTOP_LCP = path.join(PUBLIC_DIR, "online-insurance.webp");
...
async function optimizeImages() {
  ...
  try {
    ...
    console.log(`  - /online-insurance.webp (за мобилни устройства)`);
    console.log(`  - /online-insurance.webp (за десктоп устройства)`);
    console.log(
