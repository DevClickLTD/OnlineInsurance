            ...
            <TabGroup className="mt-2">
              ...
              <div className="border-b border-gray-200">
                <TabList className="-mb-px flex space-x-8 px-4">
                  {navigation.categories.map((category) => (
                    <Tab
                      key={category.name}
                      className="flex-1 border-b-2 border-transparent px-1 py-4 text-xl font-bold text-center text-gray-900 hover:text-[#47a7d7] data-headlessui-state-selected:border-[#47a7d7] data-headlessui-state-selected:text-[#47a7d7]"
                    >
                      {category.name}
                    </Tab>
                  ))}
              ...
              {loading && (
                <div className="flex justify-center py-10">
                  <div className="w-12 h-12 border-4 border-gray-500 border-t-[#47a7d7] rounded-full animate-spin"></div>
                </div>
              )}
              {!loading && (
            ...
            <div className="flex items-center justify-between h-16 lg:h-16">
              ...
              <div className="w-1/4 lg:w-1/5 flex items-center justify-start">
                <Link href="/" className="block">
                  <span className="sr-only">OnlineInsurance.bg</span>
                  <Image
                    width={180}
                    height={40}
                    alt="OnlineInsurance.bg лого"
                        ...
                        {({ open, close }) => (
                          <>
                            <div className="relative flex">
                              <PopoverButton className="relative z-10 -mb-px flex items-center border-b-2 border-transparent pt-px font-medium text-gray-700 transition-all duration-200 ease-out hover:text-gray-800 data-open:border-[#47a7d7] data-open:text-[#47a7d7] cursor-pointer focus-visible:outline-none text-base">
                                {category.name}
                                <ChevronDownIcon
